...
-- sprites that only load if Low Quality is turned off
	if not lowQuality then
		makeLuaSprite('sky','Green Hill/sky2', -100, 00);
		setLuaSpriteScrollFactor('sky', 0.1, 0.1);
		
		makeLuaSprite('city','Green Hill/city2', -10, 0);
		setLuaSpriteScrollFactor('city', 0.3, 0.3);
		scaleObject('city', 0.85, 0.85);
		makeAnimatedLuaSprite('light', 'Green Hill/light',-10, 0);
        setLuaSpriteScrollFactor('light', 0.3, 0.3);		
	    scaleObject('light',0.85, 0.85);
		makeLuaSprite('behindTrain','Green Hill/behindTrain2', -40, 50);
		makeLuaSprite('street','Green Hill/street2', -40, 50);
